...
__Aclaración:__
Este artículo es una reescritura de un post que existia en mi [antiguo blog](como-desarrolle-mi-blog), del cual no me gustaba el enfoque y decidí rehacerlo desde un punto de vista más didáctico con enfoques prácticos que apliqué en esta web. Bajo ningún punto de vista me considero un profesional en accesibilidad pero es un tópico que me interesa mucho y considero muy importante.
...
Si todo esto no te pareció un motivo suficiente para interesarte por la accesibilidad, es esencial destacar que las __WCAG 2.0__ son __legalmente obligatorias__ en muchos países. Incluso, el incumplimiento de estas pautas puede resultar en sanciones económicas en ciertas jurisdicciones.
...
Este sitio es bastante simple, por lo que con el correcto uso de los elementos HTML y algunos atributos ARIA obtenemos
una experiencia de usuario bastante digna. De todas formas seguramente queden mejores pendientes en cuanto accesibilidad se refiere
que iré haciendo con el tiempo.

Por último, quiero recomendar realmente la lectura de [Accesibilidad Web, WCAG 2.1 de forma sencilla](https://olgacarreras.blogspot.com/2018/11/libro-accesibilidad-web-wcag-21-de.html) que no solo
abarca este tema mucho mejor que yo, sino con mayor profundidad. Tambien nos ofrece el punto de vista de como seria aplicar la accesibilidad en un equipo de trabajo.

Creo que es importante que como desarrolladores consideremos seriamente este tema. Con no tanto trabajo podemos lograr
buenos resultados que hagan a nuestro sitio más accesible.
