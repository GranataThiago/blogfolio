...
date: 2024-01-03T13:12:19.472Z
preview: ../../assets/accesibilidad.webp
description: Qué es la accesibilidad y cómo podemos desarrollar sitios accesibles para que sean usables por la mayor cantidad de usuarios sin importar sus circunstancias.
relatedPosts:
...
__Aclaración:__
Este artículo es una reescritura de un post que existia en mi [antiguo blog](como-desarrolle-mi-blog), del cual no me gustaba el enfoque y decidí rehacerlo desde un punto de vista más didáctico con enfoques prácticos que apliqué en esta web.
...
- [Propiedades](https://www.w3.org/TR/wai-aria-1.1/#state_prop_def): nos permiten agregarle un mejor significado o semantica a los elementos.
- [Estados](https://www.w3.org/TR/wai-aria-1.1/#state_prop_def): propiedades especiales que definen la condición actual de los elementos. Son diferentes de las propiedades ya que el estado puede cambiar a lo largo del ciclo de vida de nuestra app (ej. `aria-expanded`).
...
Despues de realizar algunas correcciones manuales, decidí realizar algunas pruebas automáticas con Lighthouse y Validator W3.
